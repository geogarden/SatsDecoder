...
tlm_map = {
    # tlm
    REGULAR_COMMON: regular_common._name / regular_common,
    REGULAR_X: regular_x._name / regular_x,
    REGULAR_Y: regular_y._name / regular_y,
    REGULAR_Z: regular_z._name / regular_z,
    PSU_REGULAR0: psu_regular0._name / psu_regular0,
    PSU_REGULAR1: psu_regular1._name / psu_regular1,
    PSU_REGULAR2: psu_regular2._name / psu_regular2,
    PSU_REGULAR3: psu_regular3._name / psu_regular3,
    PSU_REGULAR4: psu_regular4._name / psu_regular4,
    PSU_REGULAR5: psu_regular5._name / psu_regular5,
    ACK: ack._name / ack,
    NACK: nack._name / nack,
    INFO: Info._name / Info,
    REGULAR_TEMPERATURE: regular_temperature._name / regular_temperature,
    GET_PAYLOAD_TELEMETRY: get_Payload_telemetry._name / get_Payload_telemetry,
    RATESENS_REGULAR_X: ratesens_regular_x._name / ratesens_regular_x,
    RATESENS_REGULAR_Y: ratesens_regular_y._name / ratesens_regular_y,
    RATESENS_REGULAR_Z: ratesens_regular_z._name / ratesens_regular_z,
    MAGNSENS_REGULAR_X: magnsens_regular_x._name / magnsens_regular_x,
    MAGNSENS_REGULAR_Y: magnsens_regular_y._name / magnsens_regular_y,
    MAGNSENS_REGULAR_Z: magnsens_regular_z._name / magnsens_regular_z,
    VECTOR_X: Vector_X._name / Vector_X,
    VECTOR_Y: Vector_Y._name / Vector_Y,
    VECTOR_Z: Vector_Z._name / Vector_Z,
    BRIGHTNESS: Brightness._name / Brightness,
    COMMON_TELEMETRY: common_telemetry._name / common_telemetry,
    VHF_SETTINGS: vhf_settings._name / vhf_settings,
    BEACON: beacon._name / beacon,
    EXTENDED_BEACON: extended_beacon._name / extended_beacon,
    TIME_REQUEST: time_request._name / time_request,
    UHF_BEACON: uhf_beacon._name / uhf_beacon,
    DETECTOR_TRANSMITS: detector_transmits._name / detector_transmits,
    DATA_MASSIVE_ADDR_RPL: data_massive_addr_rpl._name / data_massive_addr_rpl,
    DATA_EVENT_ADDR_RPL: data_event_addr_rpl._name / data_event_addr_rpl,
    DATA_MONITOR_ADDR_RPL: data_monitor_addr_rpl._name / data_monitor_addr_rpl,
    DATA_MASSIVE_RPL: data_massive_rpl._name / data_massive_rpl,
    DATA_EVENT_RPL: data_event_rpl._name / data_event_rpl,
    DATA_MONITOR_RPL: data_monitor_rpl._name / data_monitor_rpl,
    GET_PAYLOAD_FW_MSG: get_Payload_FW_MSG._name / get_Payload_FW_MSG,
    NO_MONITOR_DATA: no_monitor_data._name / no_monitor_data,
    NO_EVENT_DATA: no_event_data._name / no_event_data,
    NO_MASSIVE_DATA: no_massive_data._name / no_massive_data,
    COMPL_MONITOR_DATA: compl_monitor_data._name / compl_monitor_data,
    COMPL_EVENT_DATA: compl_event_data._name / compl_event_data,
    COMPL_MASSIVE_DATA: compl_massive_data._name / compl_massive_data,
    GET_PAYLOAD_CURRENT_CONFIG: get_Payload_CURRENT_CONFIG._name / get_Payload_CURRENT_CONFIG,
    REGULAR_TELEMETRY: regular_telemetry._name / regular_telemetry,
    EXTENDED_TELEMETRY: extended_telemetry._name / extended_telemetry,
    ACKNOWLEDGE: acknowledge._name / acknowledge,
    OVERCURRENT: overcurrent._name / overcurrent,
    SWITCH_STATUS: switch_status._name / switch_status,
    REGULAR_TELEMETRY6U: regular_telemetry6u._name / regular_telemetry6u,
    PS_REGULAR_TELEMETRY_5CH: ps_regular_telemetry_5ch._name / ps_regular_telemetry_5ch,
    TM_ADCS_BEACON_OLD: tm_adcs_beacon_old._name / tm_adcs_beacon_old,
    TM_ADCS_BEACON: tm_adcs_beacon._name / tm_adcs_beacon,
    TM_ADCS_BEACON_6_WHEELS: tm_adcs_beacon_6_wheels._name / tm_adcs_beacon_6_wheels,
    CH_ADC_X1: ch_adc_X1._name / ch_adc_X1,
    CH_ADC_X2: ch_adc_X2._name / ch_adc_X2,
    CH_ADC_Y1: ch_adc_Y1._name / ch_adc_Y1,
    CH_ADC_Y2: ch_adc_Y2._name / ch_adc_Y2,
    TEMP_CUR_X1: temp_cur_X1._name / temp_cur_X1,
    TEMP_CUR_X2: temp_cur_X2._name / temp_cur_X2,
    TEMP_CUR_Y1: temp_cur_Y1._name / temp_cur_Y1,
    TEMP_CUR_Y2: temp_cur_Y2._name / temp_cur_Y2,
    VERSION_SW: version_sw._name / version_sw,

}

filetransfer = {
    FILETRANSFER_INIT: filetransfer_init._name / filetransfer_init,
    FILETRANSFER_FILESIZE: filetransfer_filesize._name / filetransfer_filesize,
    FILETRANSFER_DATA: filetransfer_data._name / filetransfer_data,
}
